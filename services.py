...
def MakeAddMessage(classId):
  messageResourcePayload = None
  messageResponse = None
  messageResourcePayload = resourceDefinitions.makeOfferClassMessage(classId)
  messageResponse = restMethods.insertAddClassMessage(messageResourcePayload, classId)
