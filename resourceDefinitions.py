...
#
###############################
def makeOfferClassMessage(classId):
  payload = {}
      ...
      "translatedValues": [
        {
          ...
          "language": "ru",
          "value": "Это Тестовое сообщение аха"
        }
      ],
      "defaultValue": {
        "kind": "walletobjects#translatedString",
        "language": "en",
        "value": "That is test message hey"
      }
    },
    "body": "Hello World",
    "localizedBody": {
      ...
      "translatedValues": [
        {
          "kind": "walletobjects#translatedString",
          "language": "ru",
          "value": "Привет мир Ура Ура!!!"
        }
      ],
      "defaultValue": {
        "kind": "walletobjects#translatedString",
        "language": "en",
        "value": "Hello world yep"
      }
    },
    "displayInterval": {
      "kind": "walletobjects#timeInterval",
      "start": {
        "date": "2019-07-19T00:00:00.00Z"
      },
      "end": {
        "date": "2019-07-19T23:59:59.00Z"
      }
    },
    "id": "message_id_4",
    "messageType": "text"
